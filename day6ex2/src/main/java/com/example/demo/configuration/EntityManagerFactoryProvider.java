...
public class EntityManagerFactoryProvider {
    ...
    private static final String DDL_GENERATION = null;
	private static final String DROP_AND_CREATE = null;
	private static final String DDL_GENERATION_MODE = null;
	private static final String DDL_DATABASE_GENERATION = null;
	private static final String CLASSLOADER = null;
	private static final String LOGGING_LEVEL = null;
	private static final String CACHE_SHARED_DEFAULT = null;
	private static final String CONNECTION_POOL_MAX = null;
    ...
    public static LocalContainerEntityManagerFactoryBean get(DataSource dataSource, String... packagesToScan) {
        ...
        entityManagerFactoryBean.setPersistenceProvider((jakarta.persistence.spi.PersistenceProvider) new PersistenceProvider());
